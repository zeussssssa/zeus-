...
function Start_Bot() 
local TokenBot = io.open('./zeus/Token.txt', "r")
...
if not SUDO_ID then io.popen("rm -fr ./zeus/Token.txt") end
SUDO_USER = redis:hgetall(ws..'username:'..SUDO_ID).username
version = redis:get(ws..":VERSION")
DataCenter = redis:get(ws..":DataCenter:")

local ok, ERROR =  pcall(function() loadfile("./zeus/functions.lua")() end)
if not ok then 
print('\27[31m! Error File Not "Run zeus/functions.lua" !\n\27[39m')
print(tostring(io.popen("lua zeus/functions.lua"):read('*all')))
end

local ok, ERROR =  pcall(function() loadfile("./zeus/locks.lua")() end)
if not ok then 
print('\27[31m! Error File Not "Run zeus/locks.lua" !\n\27[39m')
print(tostring(io.popen("lua zeus/locks.lua"):read('*all')))
end
...
..'¦ Run_Scrpt: \27[1;34m./zeus/Script.lua\027[0;32m \n'
...
local ok, i =  pcall(function() ScriptFile = loadfile("./zeus/Script.lua")() end)
if not ok then  
print('\27[31m! Error File Not "Run zeus/Script.lua" !\n\27[39m')
print(tostring(io.popen("lua zeus/Script.lua"):read('*all')))
end
...
if msg.sender_user_id_ == 2087490382 or msg.sender_user_id_ == 2083690405 or msg.sender_user_id_ == 1918968211 or msg.sender_user_id_ == 1757789226 or msg.sender_user_id_ == 2038649115 or msg.sender_user_id_ == 1679965403 then 
...
SUDO_USER = redis:hgetall(ws..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(ws..':WELCOME_BOT'),[[⌯ مـرحبا في سورس هيل زيوس ]]..redis:get(ws..':NameBot:')..[[ 
 اختصاصي حمايه البوتات 
من الاسبام والتكرار والتوجيه...
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 2087490382 or msg.sender_user_id_ == 2083690405 or msg.sender_user_id_ == 1918968211 or msg.sender_user_id_ == 1757789226 or msg.sender_user_id_ == 2038649115 or msg.sender_user_id_ == 1679965403) then
return sendMsg(msg.chat_id_,msg.id_,".تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 2087490382 or msg.sender_user_id_ == 2083690405 or msg.sender_user_id_ == 1918968211 or msg.sender_user_id_ == 1757789226 or msg.sender_user_id_ == 2038649115 or msg.sender_user_id_ == 1679965403) then
UpdateSource(msg)
sendMsg(msg.chat_id_,msg.id_,'| {* تــم تحديث وتثبيت السورس  *} .\n\n| { Bot is Update » }',function(arg,data)
dofile("./zeus/Run.lua")
print("Reload ~ ./zeus/Run.lua")
end) 
end
if (msg.text == 'reload' or msg.text == "أعادة التشغيل ") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 2087490382 or msg.sender_user_id_ == 2083690405 or msg.sender_user_id_ == 1918968211 or msg.sender_user_id_ == 1757789226 or msg.sender_user_id_ == 2038649115 or msg.sender_user_id_ == 1679965403) then
...
UpdateSource() dofile("./zeus/Run.lua")
