...
if edit then EditMsg(msg.chat_id_,msg.id_,'10% - |█    @h_e_l_l1    |') end
if edit then EditMsg(msg.chat_id_,msg.id_,'20% - |███  @h_e_l_l1      |') end
download_file('https://raw.githubusercontent.com/SalemEgy/ws/main/zeus/Run.lua','./zeus/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████  @h_e_l_l1    |') end
download_file('https://raw.githubusercontent.com/SalemEgy/ws/main/zeus/locks.lua','./zeus/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████  @h_e_l_l1  |') end
download_file('https://raw.githubusercontent.com/SalemEgy/ws/main/zeus/Script.lua','./zeus/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████ @h_e_l_l1 |') end
download_file('https://raw.githubusercontent.com/SalemEgy/ws/main/zeus/functions.lua','./zeus/functions.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'100% - |█████████████|\n\n تم تحديث السورس الى اصدار *v'..redis:get(ws..":VERSION")..'*\n تم اعاده تشغيل السورس بنجاح\n - @h_e_l_l9') end
if edit then dofile("./zeus/Run.lua") end
print("Update Source And Reload ~ ./zeus/Run.lua")
...
usernn = data.username_ or "h_e_l_l9"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "h_e_l_l9"
end
Name = Name:gsub('[[][]]','')
...
var = 'هذا البوت' 
elseif UserID == 2087490382 or UserID == 1918968211 or UserID == 2083690405 or UserID == 1757789226 or UserID == 2038649115 or UserID == 1679965403 then 
var = 'مطور السورس'
...
message = message ..i.. '-l ['..info.username..'](t.me/h_e_l_l9) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/h_e_l_l9) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/h_e_l_l9) l » (`' ..v.. '`) \n'
end
end
end
...
function zeus(msg)
local list = redis:smembers(ws..'zeus:'..msg.chat_id_)
...
function zeus1(msg)
local list = redis:smembers(ws..'zeus1:'..msg.chat_id_)
...
function zeus2(msg)
local list = redis:smembers(ws..'zeus2:'..msg.chat_id_)
...
function zeus3(msg)
local list = redis:smembers(ws..'zeus3:'..msg.chat_id_)
...
function zeus4(msg)
local list = redis:smembers(ws..'zeus4:'..msg.chat_id_)
...
local Save_Data = io.open("./zeus/"..Bot_User..".json","w+")
Save_Data:write(json_data..'}}')
Save_Data:close()
sendDocument(msg.chat_id_,msg.id_,"./zeus/"..Bot_User..".json","| ملف النسخه الاحتياطيه ...\n🔖| المجموعات » { "..#All_Groups_ID.." }\n| للبوت » "..Bot_User.."\n📆| التاريخ » "..os.date("%Y/%m/%d").."\n",dl_cb,nil)
end
...
file = io.open("./zeus/All_Groups.html", "w")
file:write([[
<html dir="rtl">
<head>
...
file:close()
return sendDocument(msg.chat_id_,msg.id_,'./zeus/All_Groups.html',' قائمه المجموعات بالكامله  \n يحتوي ('..#list..') مجموعه \nافتح الملف في عارض HTML او بالمتصفح',dl_cb,nil)
else 
...
if cmd == "raf3zeus" then
if redis:sismember(ws..'zeus:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه قرد  في المجموعه \n") 
end

redis:hset(ws..'username:'..UserID, 'username', Resolv)
redis:sadd(ws..'zeus:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم رفعه قرد مجموعه \n") 
end

if cmd == "tnzelzeus" then
if not redis:sismember(ws..'zeus:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيل القرد \n") 
end
redis:srem(ws..'zeus:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم تنزيله من قائمه القرده\n") 
end

if cmd == "raf3zeus1" then
if redis:sismember(ws..'zeus1:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه قلبك في المجموعه \n") 
end

redis:hset(ws..'username:'..UserID, 'username', Resolv)
redis:sadd(ws..'zeus1:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم رفعه قلبك \n") 
end

if cmd == "tnzelzeus1" then
if not redis:sismember(ws..'zeus1:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيل قلبك \n") 
end
redis:srem(ws..'zeus1:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم تنزيله من قائمه القلوب\n") 
end

if cmd == "raf3zeus2" then
if redis:sismember(ws..'zeus2:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه العضو وتكه في المجموعه \n") 
end

redis:hset(ws..'username:'..UserID, 'username', Resolv)
redis:sadd(ws..'zeus2:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم رفعه وتكه \n") 
end

if cmd == "tnzelzeus2" then
if not redis:sismember(ws..'zeus2:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيل الوتكه \n") 
end
redis:srem(ws..'zeus2:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم تنزيله من قائمه الوتك\n") 
end

if cmd == "raf3zeus3" then
if redis:sismember(ws..'zeus3:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعها زوجتك في المجموعه \n") 
end

redis:hset(ws..'username:'..UserID, 'username', Resolv)
redis:sadd(ws..'zeus3:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم رفعها زوجتك \n") 
end

if cmd == "tnzelzeus3" then
if not redis:sismember(ws..'zeus3:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيل الجثه من زوجاتك \n") 
end
redis:srem(ws..'zeus3:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم تنزيله من قائمه زوجاتك\n") 
end

if cmd == "raf3zeus4" then
if redis:sismember(ws..'zeus4:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه زوجك في المجموعه \n") 
end

redis:hset(ws..'username:'..UserID, 'username', Resolv)
redis:sadd(ws..'zeus4:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم رفعه زوجك دلعيه \n") 
end

if cmd == "tnzelzeus4" then
if not redis:sismember(ws..'zeus4:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌯ المستخدم  ⋙「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيل العضو من قائمه ازواجك \n") 
end
redis:srem(ws..'zeus4:'..ChatID,UserID)
...
if UserID == 2087490382 or UserID == 1918968211 or UserID == 2083690405 or UserID == 1757789226 or UserID == 2038649115 or UserID == 1679965403 then return sendMsg(ChatID,MsgID,"⌯ لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
