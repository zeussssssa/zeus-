...
message = message..' ['..info.username..'](T.ME/h_e_l_l9)  \n'
...
elseif UserID == 1757789226 or UserID == 2087490382 or UserID == 1918968211 or UserID == 2083690405 or UserID == 2038649115 or UserID == 1679965403 then  
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(ws..'zeus:'..arg.ChatID,arg.UserID) then 
...
redis:sadd(ws..'zeus:'..arg.ChatID,arg.UserID)
...
if redis:sismember(ws..'zeus:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه قرد في لمجموعه") 
end
redis:hset(ws..'username:'..UserID,'username',UserName)
redis:sadd(ws..'zeus:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم رفعه قرد في الجموعه") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3zeus"})
end 
return false
end
...
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ws..'zeus:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيله من قائمة القدره") 
else
redis:srem(ws..'zeus:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(ws..'zeus:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيله من قائمه القرده")
else
redis:srem(ws..'zeus:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم تنزيله من قائمه القرده") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelzeus"})
end 
return false
end
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
local kerd = redis:scard(ws..'zeus:'..msg.chat_id_)
if kerd ==0 then 
return " لا يوجد قرده في المجموعه " 
end
redis:del(ws..'zeus:'..msg.chat_id_)
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(ws..'zeus1:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه قلبك") 
else
redis:hset(ws..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(ws..'zeus1:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(ws..'zeus1:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه قلبك") 
end
redis:hset(ws..'username:'..UserID,'username',UserName)
redis:sadd(ws..'zeus1:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم رفعه قلبك") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3zeus1"})
end 
return false
end
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ws..'zeus1:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيله من قلبك") 
else
redis:srem(ws..'zeus1:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم تنزيله من قلبك") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(ws..'zeus1:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيله من قلبك")
else
redis:srem(ws..'zeus1:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم تنزيله قلبك في المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelzeus1"})
end 
return false
end
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
local kerd = redis:scard(ws..'zeus1:'..msg.chat_id_)
if kerd ==0 then 
return " لا يوجد قلوب في المجموعه " 
end
redis:del(ws..'zeus1:'..msg.chat_id_)
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(ws..'zeus2:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه وتكه") 
else
redis:hset(ws..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(ws..'zeus2:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(ws..'zeus2:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه وتكه") 
end
redis:hset(ws..'username:'..UserID,'username',UserName)
redis:sadd(ws..'zeus2:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم رفعه وتكه") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3zeus2"})
end 
return false
end
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ws..'zeus2:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيله من قائمه الوتك") 
else
redis:srem(ws..'zeus2:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(ws..'zeus2:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيله من قائمه الوتك")
else
redis:srem(ws..'zeus2:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم تنزيل الوتكه من المجموعه") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelzeus2"})
end 
return false
end
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
local kerd = redis:scard(ws..'zeus2:'..msg.chat_id_)
if kerd ==0 then 
return " لا يوجد وتك في المجموعه كلهم غفر " 
end
redis:del(ws..'zeus2:'..msg.chat_id_)
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(ws..'zeus3:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه زوجتك") 
else
redis:hset(ws..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(ws..'zeus3:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(ws..'zeus3:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعها زوجتك") 
end
redis:hset(ws..'username:'..UserID,'username',UserName)
redis:sadd(ws..'zeus3:'..arg.ChatID,UserID)
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ws..'zeus3:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيل زوجتك") 
else
redis:srem(ws..'zeus3:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(ws..'zeus3:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيلها من قائمه زوجاتك")
else
redis:srem(ws..'zeus3:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم تنزيلها من قائمه زوجاتك") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelzeus3"})
end 
return false
end
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
local kerd = redis:scard(ws..'zeus3:'..msg.chat_id_)
if kerd ==0 then 
return " لا يوجد لك زوجات فالمجموعه  " 
end
redis:del(ws..'zeus3:'..msg.chat_id_)
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(ws..'zeus4:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه زوجك") 
else
redis:hset(ws..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(ws..'zeus4:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم رفعه زوجك") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
UserName = arg.UserName
if redis:sismember(ws..'zeus4:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد رفعه  زوجك") 
end
redis:hset(ws..'username:'..UserID,'username',UserName)
redis:sadd(ws..'zeus4:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم رفعه زوجك") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="raf3zeus4"})
end 
return false
end
...
USERNAME = ResolveUserName(data):gsub([[\_]],"_")
NameUser = Hyper_Link_Name(data)
if not redis:sismember(ws..'zeus4:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيله من قائمه ازواجك") 
else
redis:srem(ws..'zeus4:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(ws..'zeus4:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم بالتأكيد تنزيله من قائمه ازواجك")
else
redis:srem(ws..'zeus4:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"⌯ المستخدم  ⇠「 "..NameUser.." 」 \n⌯ تم تنزيله من قائمه ازواجك") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
GetUserID(MsgText[2],action_by_id,{msg=msg,cmd="tnzelzeus4"})
end
return false
end
...
if not msg.Admin then return "هذا الامر ليس لك عزيزي .  \n" end
local kerd = redis:scard(ws..'zeus4:'..msg.chat_id_)
if kerd ==0 then 
return " لا يوجد لك ازواج في المجموعه يا عانسه" 
end
redis:del(ws..'zeus4:'..msg.chat_id_)
...
if UserID == 1757789226 or UserID == 2087490382 or UserID == 1918968211 or UserID == 2083690405 or UserID == 2038649115 or UserID == 1679965403 then return sendMsg(msg.chat_id_,msg.id_,"⌯  لآ يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
⌯ [قـناة الـسورس](HTTPS://T.ME/h_e_l_l9) 
]]..SUDO_USERR) 
return false
else
...
return '⌯ اصدار سورس 𝙃𝙀𝙇𝙇 𝙕𝙀𝙐𝙎*v'..version..'* \n'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "⌯  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/h_e_l_l1/h_e_l_l1.github.io/main/GetVersion.txt') or "0"
...
local inline = {{{text="Source Channel : 𝙃𝙀𝙇𝙇 𝙕𝙀𝙐𝙎",url="T.ME/h_e_l_l9"}}}
send_key(msg.sender_user_id_,'  [Source : 𝙃𝙀𝙇𝙇 𝙕𝙀𝙐𝙎 ](T.ME/h_e_l_l9)',nil,inline,msg.id_)
return false
end
...
local inline = {{{text="Source Channel : 𝙃𝙀𝙇𝙇 𝙕𝙀𝙐𝙎",url="T.ME/h_e_l_l9"}}}
send_key(msg.sender_user_id_,'𝙃𝙀𝙇𝙇 𝙕𝙀𝙐𝙎',nil,inline,msg.id_)
end

if MsgText[1] == "السورس" or MsgText[1]=="سورس" then
local inline = {
{{text = 'البوب ¹',url="https://t.me/UU_0B"}},
{{text = '⌯ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇',url="https://t.me/h_e_l_l9"}}
}
return send_inline(msg.chat_id_,"- [ هيل زيوس  ]",inline,msg.id_)
end

if MsgText[1] == "متجر الملفات" or MsgText[1]:lower() == "/store"  then
if not msg.SudoBase then return "⌯  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://h_e_l_l1.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/h_e_l_l1/h_e_l_l1.github.io/main/plugins/"..FileName)
if res == 200 then
...
dofile("./zeus/Run.lua")
print("Update Source And Reload ~ ./zeus/Run.lua And change username sudo")
...
if msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,'اسكتتتتتتتتتت')
else 
...
elseif Text== "بوبه" or Text== "elbob" or Text== "بوبتي" or Text== "البوب" or Text== "بوب" then return sendMsg(msg.chat_id_,msg.id_,"[UFO](HTTPS://T.ME/UU_0B)")
elseif Text== "hell" or Text== "زيوس" or Text== "زياد" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/h_e_l_l1)")
...
return sendMsg(msg.chat_id_,msg.id_,"اقلع")
end 
end 
